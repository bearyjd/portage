 ...
 * concerns the `:providers` [com.ventouxlabs.portage.providers.apk.ApkApplyProvider] is wired through live
...
class PackageInstallerApkInstaller(
    ...
    companion object {
        const val PACKAGE_INSTALL_RESULT_ACTION_PREFIX = "com.ventouxlabs.portage.recv.install"
    }
}
