...
/**
 * Keeps the receiver process at foreground importance and the radio/CPU awake for the whole transfer
...
class TransferForegroundService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return Notification.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("Receiving with portage")
 ...
 * no-op. Started from a foreground Activity (the user tapped "Bring it over"), so the background-FGS
