...
```
Per-kind subpackages: contacts/ (VCard3 + extended details + name-remapped groups + starred state + bounded thumbnails) · calendar/ (Ics) · calllog/ · sms/ + mms/ (transient default-SMS
