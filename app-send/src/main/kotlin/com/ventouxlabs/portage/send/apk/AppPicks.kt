...
import com.ventouxlabs.portage.providers.apk.ApkExportProvider
import com.ventouxlabs.portage.providers.apk.InstalledApp
import com.ventouxlabs.portage.providers.apk.installedAppApkProviders
 ...
 *
 * This is the direct analogue of [com.ventouxlabs.portage.send.relay.relayExportProviders]: it turns the
 * user's picks into [ApkExportProvider]s ready to append to the sender's provider list, so
 * [com.ventouxlabs.portage.send.transfer.ManifestBuilder] stages each as its own item (distinct id + distinct
