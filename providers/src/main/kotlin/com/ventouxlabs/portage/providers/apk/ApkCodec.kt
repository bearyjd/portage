...
/**
 * Wire codec for an APK container, modeled on [com.ventouxlabs.portage.providers.relay.RelayCodec]'s
...
object ApkCodec {
     ...
     * closed (the same lifecycle [com.ventouxlabs.portage.providers.relay.RelayCodec] uses).
     *
     ...
     * Mirrors [com.ventouxlabs.portage.providers.relay.RelayCodec.readHeaderFrom]. No bytes beyond the line
     * are read.
     */
     ...
     * [com.ventouxlabs.portage.providers.relay.RelayCodec.streamBlob]; the bytes are copied VERBATIM.
     */
