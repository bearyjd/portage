 ...
 */
package com.ventouxlabs.portage.providers.relay
 ...
 * format — the same decoupling [com.ventouxlabs.portage.model.ItemKind.wire] gives for kind dispatch.
 */
@Serializable
 ...
 * Mirrors [com.ventouxlabs.portage.providers.wallpaper.WallpaperHeader]'s header+blob shape, with the same
 ...
 *
 * [itemId] is the wire item id ([com.ventouxlabs.portage.model.ItemMeta.itemId]) of the relay item that
 ...
 *
 * [itemId] comes from [com.ventouxlabs.portage.model.ItemMeta.itemId] via [nextItemId]. The caller
