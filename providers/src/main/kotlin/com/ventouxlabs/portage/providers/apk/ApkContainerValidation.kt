 ...
 * mirroring [com.ventouxlabs.portage.providers.relay.RelayHeader.sanitizedOrNull]. These validators are the
...
object ApkContainerValidation {
     ...
     * regex the inventory deep link and [com.ventouxlabs.portage.providers.relay.RelayHeader] use, so a
     ...
     * REPLICATED in [com.ventouxlabs.portage.adbbridge.LocalAdbBridge], not shared. There is no cross-module
